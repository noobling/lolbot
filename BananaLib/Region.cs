namespace BananaLib
{
    public enum Region
    {
        ...
        [FullName("Public Beta Environment"), GameServerAddress("prod.pbe1.lol.riotgames.com"), LoginQueue("https://lqak.pbe1.lol.riotgames.com/"), Locale("en_US"), UseGarena(false)] PBE,
